...
Semantic LOC counter that classifies code by role (prod, test, docs, infra) with health ratios and effort estimates.
...
**Responsibility Balance** - How code is distributed across roles (prod, test, docs, infra, config).
...
- Test / Prod - test coverage relative to production code
- Comment / Code - explanation density
- Docs / Prod - documentation coverage
- Infra / Prod - operational complexity
- Config / Prod - configuration surface area
