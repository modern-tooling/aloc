...
func TestRoleScoreResolve_AmbiguityPenalty(t *testing.T) {
	score := NewRoleScore()
	score.Add(model.RoleTest, 0.75, model.SignalFilename)
	score.Add(model.RoleProd, 0.70, model.SignalPath)
...
func TestRoleScoreResolve_EmptyScore(t *testing.T) {
	...
	if role != model.RoleProd {
		t.Errorf("Role = %v, want prod (default)", role)
	}
	if confidence != 0.30 {
...
func TestRoleScoreResolve_TieBreak(t *testing.T) {
	...
	score.Add(model.RoleProd, 0.50, model.SignalPath)
...
func TestRoleScoreMaxWeight(t *testing.T) {
	score := NewRoleScore()
	score.Add(model.RoleTest, 0.75, model.SignalFilename)
	score.Add(model.RoleProd, 0.30, model.SignalPath)
...
func TestRoleScoreMaxWeight_MultipleSignals(t *testing.T) {
	...
	score.Add(model.RoleProd, 0.50, model.SignalExtension)
