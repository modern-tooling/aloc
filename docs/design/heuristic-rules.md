...
**Examples:**
- 8/10 files in `/internal/billing/` classified as `prod` -> remaining 2 get +0.40 core
...
This avoids misclassifying third-party or generated code as core.
...
- `/internal/` suggests `core` (+0.20)
- `/cmd/` suggests `core` (+0.30)
