...
All ratios are pre-calculated as `role_loc / prod_loc`.

| Field | Type | Description |
|-------|------|-------------|
| `test_to_prod` | float | Test LOC / Prod LOC |
| `infra_to_prod` | float | Infra LOC / Prod LOC |
| `docs_to_prod` | float | Docs LOC / Prod LOC |
| `generated_to_prod` | float | Generated LOC / Prod LOC |
| `config_to_prod` | float | Config LOC / Prod LOC |
...
**Primary roles:**
- `prod` - Production application logic
